...
import { Search, Send, Paperclip, MoreVertical, CheckCheck, User } from 'lucide-react'
import { Input } from '@/components/ui/input'
import { Button } from '@/components/ui/button'

const conversations = [
  { id: '1', name: 'Tunde M.', status: 'Pending Job', lastMessage: 'Please let me know if you need any parts.', time: '10:42 AM', unread: 1, avatar: 'https://i.pravatar.cc/150?u=5' },
  { id: '2', name: 'Chioma B.', status: 'Completed', lastMessage: 'Thank you! The wiring is perfect.', time: 'Yesterday', unread: 0, avatar: 'https://i.pravatar.cc/150?u=6' },
  { id: '3', name: 'Kenneth O.', status: 'Active Job', lastMessage: 'I am arriving at your gate now.', time: 'Oct 12', unread: 0, avatar: 'https://i.pravatar.cc/150?u=7' },
]
...
export default function TechnicianMessagesPage() {
  ...
  const chatMessages = [
    { id: 1, sender: 'them', text: 'Hi, I sent a booking request for the emergency fault.', time: '10:30 AM' },
    { id: 2, sender: 'me', text: 'Hello Tunde. I received it. Can you describe the fault briefly?', time: '10:32 AM' },
    { id: 3, sender: 'them', text: 'Half of the house suddenly lost power. The breaker tripped but wont stay up when I reset it.', time: '10:35 AM' },
    { id: 4, sender: 'me', text: 'Okay, do not force it up. Sounds like a short circuit. I will come over now.', time: '10:40 AM' },
    { id: 5, sender: 'them', text: 'Please let me know if you need any parts.', time: '10:42 AM' },
  ]
    ...
    <div className="h-[calc(100vh-8rem)] -mx-6 -my-6 flex bg-background animate-in fade-in duration-700">
      ...
      <div className="w-full md:w-80 lg:w-96 border-r border-border flex flex-col bg-card/30">
        <div className="p-4 border-b border-border">
          <h2 className="text-xl font-bold text-foreground mb-4">Customer Messages</h2>
          <div className="relative">
            <Search className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-muted-foreground" />
            <Input placeholder="Search clients..." className="pl-9 bg-background border-border" />
          </div>
        </div>
          ...
          {conversations.map(chat => (
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-xs text-primary font-medium mb-1">{chat.status}</p>
      ...
      <div className="hidden md:flex flex-col flex-1 bg-[#0F1420]">
        <div className="h-20 border-b border-border bg-card px-6 flex items-center justify-between shrink-0">
          ...
          <div className="flex items-center gap-2">
            <Button variant="outline" className="border-border bg-background hover:bg-muted text-sm font-semibold h-9">View Job</Button>
